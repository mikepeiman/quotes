import{am as o,D as s}from"./vendor-0f79dfe6.js";const a="https://blue-surf-460106.us-east-1.aws.cloud.dgraph.io/graphql";console.log("\u{1F680} ~ file: dgraph-client.js ~ line 4 ~ VITE_DGRAPH_ENDPOINT",a);const c=new o.GraphQLClient(a),i=s({}),l=s({}),r=s([]),d=s([]),q=e=>{console.log("\u{1F680} ~ file: quotes.js ~ line 9 ~ addQuote ~ quote",e),d.update(t=>[...t,e]),console.log("\u{1F680} ~ file: quotes.js ~ line 11 ~ addQuote ~ addedQuotes",d)},y=async e=>{let t;console.log("\u{1F680} ~ file: quotes.js ~ line 16 ~ uploadQuote ~ quote",e);const n=o.gql`mutation MyMutation {
