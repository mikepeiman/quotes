...
var metabrainLanding_svelte_svelte_type_style_lang = "";
const css = {
...
const Metabrain_landing = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let email = "";
...
export { Metabrain_landing as default };
