import { c as create_ssr_component, e as escape, p as createEventDispatcher, k as add_attribute, v as validate_component, m as missing_component, j as each, f as spread, h as escape_object, i as escape_attribute_value, q as globals } from "./index-e675dbce.js";
import { P as Param } from "./Slider-62275319.js";
/* empty css                                                     *//* empty css                                                  */function isOutOfViewport(parent, container) {
...
const OptionSelect = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { label = "" } = $$props;
  let { items = [] } = $$props;
  let { selected = "" } = $$props;
